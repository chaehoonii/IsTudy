...
<style>
@import
url('https://cdn.rawgit.com/moonspam/NanumSquare/master/nanumsquare.css%27)
;
</style>
...
<body>
	<div class="wrap">
		<div class="userForm_wrap">
			<h2
				style="text-align: center; margin: 100px 0px 40px; font-size: 35px;">회원가입</h2>
			<form method="post" action="/users/joinOk"
				onsubmit='return userCheck()' enctype="multipart/form-data">
				<div id="user_img_wrap">

					<span id="img_upload_phr">Click here!</span> <img src=""
						id="user_img" />
				</div>
				...
				<fieldset>
					...
					<ul>
						...
						<li class="career_url"><input type="text" name="career"
							id="career_url"
							placeholder="경력을 증명할 수 있는 URL을 입력해주세요 (ex..github/blog)" /></li>
						<li>관심분야</li>
						<li>
							<ul id="radio_list">
